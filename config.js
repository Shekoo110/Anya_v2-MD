...
module.exports = {
  botname: process.env.BotName || "Miss Tollen", 
  author: process.env.Author || "Sherlock",
  packname: process.env.PackName || "Miss Tollen",
  socialLink: process.env.Web || "",
  footer: process.env.Footer || "",
  prefa: process.env.Prefix || ['-'],
  themeemoji: process.env.ThemeEmoji || "🎐",
  ownername: process.env.Owner_Name || "Mr-Kaiser",
  ownernumber: process.env.Owner_Number || "966536471289",
  ...
  sessionId: process.env.SESSION_ID || "MogulMar_AN_YA_shals
", 
